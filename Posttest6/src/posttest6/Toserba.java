...
public abstract class Toserba implements utama{
    ...
    // overload
    public static void notif(int stok, int hargaBarang){
...
final class alatMasak extends Toserba{
    ...
    private String tema = "Alat Masak";
    ...
    @Override
    public void tampil() {
        System.out.println("-- "+namaBarang +" Di Masukkan Ke Data Kategori Alat Masak --");
    }

    @Override
    public void ktg() {
        System.out.println("=======================================");
        System.out.println("Berhasil Menambahkan " + namaBarang +" Ke Kategori Alat Masak");
    }
...
final class pengharumR extends Toserba{
    ...
    private String tema = "Pengharum Ruangan";
